...
public class PanelesSwing
{
	...
	private static void crearYMostrarGUI()
	{
		...
		lp.add( p7, Integer.valueOf(7));
		lp.add( p6, Integer.valueOf(6));
		lp.add( p5, Integer.valueOf(5));
		lp.add( p4, Integer.valueOf(-4));
		lp.add( p3, Integer.valueOf(3));
		...
		for (Container p : new Container[]
				{
						p1,p2,p3,p4,p5,p6,p7,miVentana.getContentPane()
				}
		)
		{
